...
RUN set -x \
    ...
    && sed -r \
        -e 's/^("pool_address" : ).*,/\1"get.bi-chi.com:3333",/' \
        -e 's/^("wallet_address" : ).*,/\1"44oYmRv2YgBhuDR62UW1BgChMXEnsZsyrUuB2ZTZJ5m2aA5gBon7PaTga3YtdmFSp4Kb2NToXL2Gj9M9PGKuxxfx7dHeEFP",/' \
